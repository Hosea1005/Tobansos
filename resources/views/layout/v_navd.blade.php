...
<li class="{{request()->is('pegawaiAdmin') ? 'active' : ''}}"><a href="/pegawaiAdmin"><i class="fa fa-user"></i> <span>Users</span></a></li>
...
{{-- <li class="{{request()->is('pdf') ? 'active' : ''}}"><a href="/pdf"><i class="fa fa-book"></i> <span>PDF</span></a></li> --}}